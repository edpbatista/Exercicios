...
public class Tela14 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INFORME O PREÇO DE CUSTO : R$");

        jLabel2.setFont(new java.awt.Font("Dialog", 0, 18)); // NOI18N
        jLabel2.setText("INFORME O PREÇO DE VENDA : R$");
    ...
    double pc = Double.valueOf( cx1.getText());
    double pv = Double.valueOf(cx2.getText());
    if (pc > pv ){
        cx3.setText("A MARGEM DE LUCRO ESTÁ NEGATIVO");
    }else{
        if(pc == pv){
          cx3.setText("O PRODUTO ESTA SEM MARGEM DE LUCRO");
        }else {
            cx3.setText("A MARGEM DE LUCRO ESTÁ POSITIVO");
        }
    }
